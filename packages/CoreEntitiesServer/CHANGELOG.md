# @mj-biz-apps/contracts-core-entities-server

## 0.7.1

### Patch Changes

- b561a29: Default a new contract's template on the server, not only in the form (golive #269).
...
- b314a39: `Contracts.Supersede` now refuses a call carrying both `PredecessorID` and `ReleasePredecessorID`.
