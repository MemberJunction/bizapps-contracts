/**
 * @mj-biz-apps/contracts-actions — the app's ACTIONS package (OPTIONAL — delete the
 ...
 *
 *   @RegisterClass(BaseAction, 'MJ_BizApps_Contracts: Do Something')
 ...
 */
export function LoadMjBizappsContractsActions(): void {
