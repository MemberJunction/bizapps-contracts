...
**Scope of the schema as built:** 10 tables · 48 CHECK constraints · 13 internal FKs · 13 cross-app
FKs · 5 unique indexes (one filtered) · 2 covering read indexes. Every one of those is a row below.
