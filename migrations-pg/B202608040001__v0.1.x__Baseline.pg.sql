...
CREATE TABLE __mj_BizAppsContracts."ContractTemplate" (
 ...
 "ContractTemplateTypeID" UUID NOT NULL,
 ...
 "Description" TEXT NULL,
 "Status" VARCHAR(20) NOT NULL CONSTRAINT "DF_ContractTemplate_Status" DEFAULT 'Draft',
...
CREATE TABLE __mj_BizAppsContracts."ContractTemplateProvision" (
 ...
 "ProvisionNumber" VARCHAR(20) NOT NULL,
...
CREATE INDEX IF NOT EXISTS IX_ContractTemplateProvision_SortKey
...
CREATE TABLE __mj_BizAppsContracts."ContractType" (
 ...
 "Name" VARCHAR(100) NOT NULL,
 "Description" TEXT NULL,
 "RequiresExecutedDocument" BOOLEAN NOT NULL DEFAULT TRUE,
 "Status" VARCHAR(10) NOT NULL DEFAULT 'Active',
 ...
 "MustBeRoot" BOOLEAN NOT NULL CONSTRAINT "DF_ContractType_MustBeRoot" DEFAULT FALSE,
 "MustBeChild" BOOLEAN NOT NULL CONSTRAINT "DF_ContractType_MustBeChild" DEFAULT FALSE,
 -- Whether a contract of this type must carry its own ContractTemplateID.
 "TemplateRequired" BOOLEAN NOT NULL CONSTRAINT "DF_ContractType_TemplateRequired" DEFAULT FALSE,
...
CREATE TABLE __mj_BizAppsContracts."Contract" (
 ...
 "PrimaryContactPersonID" UUID NULL,
 "ContractTemplateID" UUID NULL,
 "CreatingEntityID" UUID NULL,
 "CreatingRecordID" VARCHAR(450) NULL,
 "ParentContractID" UUID NULL,
 "SupersededByContractID" UUID NULL,
 "SigningProviderURL" VARCHAR(1000) NULL,
 ...
 "CancellationWindowDays" INTEGER NULL,
...
CREATE UNIQUE  INDEX IF NOT EXISTS UQ_Contract_ContractNumber
...
CREATE INDEX IF NOT EXISTS IX_Contract_CreatingRecord
...
CREATE TABLE __mj_BizAppsContracts."ContractTemplateModification" (
 ...
 "ContractTemplateProvisionID" UUID NOT NULL,
 "ModificationText" TEXT NOT NULL,
 "Notes" TEXT NULL,
...
/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.ContractTemplateProvision */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateProvision"
 ADD COLUMN IF NOT EXISTS "__mj_UpdatedAt" TIMESTAMPTZ NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.ContractTemplateModification */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateModification"
 ADD COLUMN IF NOT EXISTS "__mj_CreatedAt" TIMESTAMPTZ NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.ContractTemplateModification */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateModification"
 ADD COLUMN IF NOT EXISTS "__mj_UpdatedAt" TIMESTAMPTZ NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.ContractTemplateType */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateType"
 ADD COLUMN IF NOT EXISTS "__mj_CreatedAt" TIMESTAMPTZ NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.ContractTemplateType */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateType"
 ADD COLUMN IF NOT EXISTS "__mj_UpdatedAt" TIMESTAMPTZ NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.ContractTemplate */
ALTER TABLE __mj_BizAppsContracts."ContractTemplate"
 ADD COLUMN IF NOT EXISTS "__mj_CreatedAt" TIMESTAMPTZ NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.ContractTemplate */
ALTER TABLE __mj_BizAppsContracts."ContractTemplate"
 ADD COLUMN IF NOT EXISTS "__mj_UpdatedAt" TIMESTAMPTZ NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.ContractType */
ALTER TABLE __mj_BizAppsContracts."ContractType"
 ADD COLUMN IF NOT EXISTS "__mj_CreatedAt" TIMESTAMPTZ NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.ContractType */
ALTER TABLE __mj_BizAppsContracts."ContractType"
 ADD COLUMN IF NOT EXISTS "__mj_UpdatedAt" TIMESTAMPTZ NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.Contract */
ALTER TABLE __mj_BizAppsContracts."Contract"
 ADD COLUMN IF NOT EXISTS "__mj_CreatedAt" TIMESTAMPTZ NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.Contract */
ALTER TABLE __mj_BizAppsContracts."Contract"
 ADD COLUMN IF NOT EXISTS "__mj_UpdatedAt" TIMESTAMPTZ NULL;

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_ContractTemplateModification_ContractID" ON __mj_BizAppsContracts."ContractTemplateModification" ("ContractID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_ContractTemplateModification_Contract_466d1781" ON __mj_BizAppsContracts."ContractTemplateModification" ("ContractTemplateProvisionID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_ContractTemplateProvision_ContractTemplateID" ON __mj_BizAppsContracts."ContractTemplateProvision" ("ContractTemplateID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_ContractTemplate_ContractTemplateTypeID" ON __mj_BizAppsContracts."ContractTemplate" ("ContractTemplateTypeID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_Contract_ContractTypeID" ON __mj_BizAppsContracts."Contract" ("ContractTypeID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_Contract_CompanyID" ON __mj_BizAppsContracts."Contract" ("CompanyID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_Contract_CustomerOrganizationID" ON __mj_BizAppsContracts."Contract" ("CustomerOrganizationID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_Contract_PrimaryContactPersonID" ON __mj_BizAppsContracts."Contract" ("PrimaryContactPersonID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_Contract_ContractTemplateID" ON __mj_BizAppsContracts."Contract" ("ContractTemplateID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_Contract_CreatingEntityID" ON __mj_BizAppsContracts."Contract" ("CreatingEntityID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_Contract_ParentContractID" ON __mj_BizAppsContracts."Contract" ("ParentContractID");

CREATE INDEX IF NOT EXISTS "IDX_AUTO_MJ_FKEY_Contract_SupersededByContractID" ON __mj_BizAppsContracts."Contract" ("SupersededByContractID");
...
AS SELECT
    c.*
FROM
    __mj_BizAppsContracts."ContractTemplateModification" AS c$vsql$;
  v_target_oid OID;
  v_dep RECORD;
...
DECLARE
  v_target_schema CONSTANT TEXT := '__mj_BizAppsContracts';
  v_target_name CONSTANT TEXT := 'vwContractTemplateTypes';
  vsql CONSTANT TEXT := $vsql$CREATE OR REPLACE VIEW __mj_BizAppsContracts."vwContractTemplateTypes"
AS SELECT
    c.*
FROM
    __mj_BizAppsContracts."ContractTemplateType" AS c$vsql$;
  v_target_oid OID;
  v_dep RECORD;
  v_captured JSONB[] := ARRAY[]::JSONB[];
  v_n INTEGER;
...
DECLARE
  v_target_schema CONSTANT TEXT := '__mj_BizAppsContracts';
  v_target_name CONSTANT TEXT := 'vwContractTypes';
  vsql CONSTANT TEXT := $vsql$CREATE OR REPLACE VIEW __mj_BizAppsContracts."vwContractTypes"
AS SELECT
    c.*
FROM
    __mj_BizAppsContracts."ContractType" AS c$vsql$;
  v_target_oid OID;
  v_dep RECORD;
  v_captured JSONB[] := ARRAY[]::JSONB[];
  v_n INTEGER;
...
DECLARE
  v_target_schema CONSTANT TEXT := '__mj_BizAppsContracts';
  v_target_name CONSTANT TEXT := 'vwContractTemplateProvisions';
  vsql CONSTANT TEXT := $vsql$CREATE OR REPLACE VIEW __mj_BizAppsContracts."vwContractTemplateProvisions"
AS SELECT
    c.*,
    "mjBizAppsContractsContractTemplate_ContractTemplateID"."Name" AS "ContractTemplate"
FROM
    __mj_BizAppsContracts."ContractTemplateProvision" AS c
INNER JOIN
    __mj_BizAppsContracts."ContractTemplate" AS "mjBizAppsContractsContractTemplate_ContractTemplateID"
  ON
    c."ContractTemplateID" = "mjBizAppsContractsContractTemplate_ContractTemplateID"."ID"$vsql$;
  v_target_oid OID;
  v_dep RECORD;
  v_captured JSONB[] := ARRAY[]::JSONB[];
  v_n INTEGER;
...
DECLARE
  v_target_schema CONSTANT TEXT := '__mj_BizAppsContracts';
  v_target_name CONSTANT TEXT := 'vwContractTemplates';
  vsql CONSTANT TEXT := $vsql$CREATE OR REPLACE VIEW __mj_BizAppsContracts."vwContractTemplates"
AS SELECT
    c.*,
...
DECLARE
  v_target_schema CONSTANT TEXT := '__mj_BizAppsContracts';
  v_target_name CONSTANT TEXT := 'vwContracts';
  vsql CONSTANT TEXT := $vsql$CREATE OR REPLACE VIEW __mj_BizAppsContracts."vwContracts"
AS SELECT
    c.*,
...
LEFT OUTER JOIN
  ...
  ON
    c."CreatingEntityID" = "MJEntity_CreatingEntityID"."ID"$vsql$;
  v_target_oid OID;
  v_dep RECORD;
  v_captured JSONB[] := ARRAY[]::JSONB[];
  v_n INTEGER;
...
-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spCreateContractTemplateType]
--     @ID UUID = NULL,
--     @Name VARCHAR(100),
...
-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spUpdateContractTemplateType]
--     @ID UUID,
...
-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spCreateContractType]
--     @ID UUID = NULL,
--     @Name VARCHAR(100),
--     @Description_Clear bit = 0,
--     @Description TEXT = NULL,
...
-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spUpdateContractType]
--     @ID UUID,
--     @Name VARCHAR(100) = NULL,
--     @Description_Clear bit = 0,
--     @Description TEXT = NULL,
...
-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spDeleteContractTemplateType]
--     @ID UUID
-- AS
-- BEGIN
--     SET NOCOUNT ON;
-- 
--     DELETE FROM
--         [__mj_BizAppsContracts].[ContractTemplateType]
--   ...

-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spDeleteContractType]
--     @ID UUID
-- AS
-- BEGIN
--     SET NOCOUNT ON;
-- 
--     DELETE FROM
--         [__mj_BizAppsContracts].[ContractType]
--     WHERE
--         ...

-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spCreateContractTemplateProvision]
--     @ID UUID = NULL,
--     @ContractTemplateID UUID,
--     @ProvisionNumber VARCHAR(20),
--     @Title nv...

-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spUpdateContractTemplateProvision]
--     @ID UUID,
--     @ContractTemplateID UUID = NULL,
--     @ProvisionNumber VARCHAR(20) = NULL,
--     @T...

-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spDeleteContractTemplateProvision]
--     @ID UUID
-- AS
-- BEGIN
--     SET NOCOUNT ON;
-- 
--     DELETE FROM
--         [__mj_BizAppsContracts].[ContractTemplatePro...

-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spCreateContractTemplate]
--     @ID UUID = NULL,
--     @Name VARCHAR(200),
--     @ContractTemplateTypeID UUID,
--     @VersionLabel_Clear bit ...

-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spUpdateContractTemplate]
--     @ID UUID,
--     @Name VARCHAR(200) = NULL,
--     @ContractTemplateTypeID UUID = NULL,
--     @VersionLabel_Cle...

-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spDeleteContractTemplate]
--     @ID UUID
-- AS
-- BEGIN
--     SET NOCOUNT ON;
...
-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spCreateContract]
--     @ID UUID = NULL,
--     @ContractNumber_Clear bit = 0,
--     @ContractNumber VARCHAR(50) = NULL,
--     @ContractTypeID uniqueident...

-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spUpdateContract]
--     @ID UUID,
--     @ContractNumber_Clear bit = 0,
--     @ContractNumber VARCHAR(50) = NULL,
--     @ContractTypeID UUID =...
...
-- SKIPPED: procedure (auto-conversion not supported)
-- CREATE PROCEDURE [__mj_BizAppsContracts].[spDeleteContract]
--     @ID UUID
-- AS
-- BEGIN
--     SET NOCOUNT ON;
-- 
--     DELETE FROM
--         [__mj_BizAppsContracts].[Contract]
--     WHERE
--         [ID] = @...
...
--     version neither gains, loses nor changes c
...
-- SKIPPED: trigger (auto-conversion not supported)
-- CREATE TRIGGER [__mj_BizAppsContracts".trgUpdateContractTemplateType
ON "__mj_BizAppsContracts"."ContractTemplateType"
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
...
-- SKIPPED: trigger (auto-conversion not supported)
-- CREATE TRIGGER [__mj_BizAppsContracts".trgUpdateContractType
ON "__mj_BizAppsContracts"."ContractType"
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
    UPDATE
        "__mj_BizAppsContracts"."ContractTyp

-- SKIPPED: trigger (auto-conversion not supported)
-- CREATE TRIGGER [__mj_BizAppsContracts".trgUpdateContractTemplateProvision
ON "__mj_BizAppsContracts"."ContractTemplateProvision"
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
...
-- SKIPPED: trigger (auto-conversion not supported)
-- CREATE TRIGGER [__mj_BizAppsContracts".trgUpdateContractTemplate
ON "__mj_BizAppsContracts"."ContractTemplate"
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
    UPDATE
        "__mj_BizAppsContracts"."Con

-- SKIPPED: trigger (auto-conversion not supported)
-- CREATE TRIGGER [__mj_BizAppsContracts".trgUpdateContract
ON "__mj_BizAppsContracts"."Contract"
AFTER UPDATE
AS
BEGIN
    SET NOCOUNT ON;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM __mj."SchemaInfo" WHERE "SchemaName" = '__mj_BizAppsContracts'
    ) THEN
...
/* SQL generated to create new application __mj_BizAppsContracts */
...
BEGIN
    IF NOT EXISTS (
        ...
        VALUES ('891e92fe-561a-4fed-8edc-e2d96fb18541', '__mj_BizAppsContracts', 'Generated for schema', '__mj_BizAppsContracts', 'mjbizappscontracts', 1, 0);
    END IF;
END $$;
...
INSERT INTO ${mjSchema}."ApplicationEntity"
                                       ...
                                       ('891e92fe-561a-4fed-8edc-e2d96fb18541', '4e3f97be-e196-4cc0-9b5d-cc50de8967a0', (SELECT COALESCE(MAX("Sequence"),0)+1 FROM ${mjSchema}."ApplicationEntity" WHERE "ApplicationID" = '891e92fe-561a-4fed-8edc-e2d96fb18541'), NOW(), NOW());
...
INSERT INTO ${mjSchema}."EntityPermission"
                                                   ...
                                                   ('4e3f97be-e196-4cc0-9b5d-cc50de8967a0', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Template Types for role Developer */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('4e3f97be-e196-4cc0-9b5d-cc50de8967a0', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Template Types for role Integration */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('4e3f97be-e196-4cc0-9b5d-cc50de8967a0', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());
...
INSERT INTO ${mjSchema}."ApplicationEntity"
                                       ("ApplicationID", "EntityID", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                       ('891E92FE-561A-4FED-8EDC-E2D96FB18541', '731f2890-1415-40de-9073-d22ea23392b3', (SELECT COALESCE(MAX("Sequence"),0)+1 FROM ${mjSchema}."ApplicationEntity" WHERE "ApplicationID" = '891E92FE-561A-4FED-8EDC-E2D96FB18541'), NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Templates for role UI */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('731f2890-1415-40de-9073-d22ea23392b3', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Templates for role Developer */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('731f2890-1415-40de-9073-d22ea23392b3', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Templates for role Integration */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('731f2890-1415-40de-9073-d22ea23392b3', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());
...
INSERT INTO ${mjSchema}."ApplicationEntity"
                                       ("ApplicationID", "EntityID", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                       ('891E92FE-561A-4FED-8EDC-E2D96FB18541', '317df592-8c20-473d-b097-2ab239877438', (SELECT COALESCE(MAX("Sequence"),0)+1 FROM ${mjSchema}."ApplicationEntity" WHERE "ApplicationID" = '891E92FE-561A-4FED-8EDC-E2D96FB18541'), NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Template Provisions for role UI */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('317df592-8c20-473d-b097-2ab239877438', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Template Provisions for role Developer */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('317df592-8c20-473d-b097-2ab239877438', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Template Provisions for role Integration */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('317df592-8c20-473d-b097-2ab239877438', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());
...
INSERT INTO ${mjSchema}."ApplicationEntity"
                                       ("ApplicationID", "EntityID", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                       ('891E92FE-561A-4FED-8EDC-E2D96FB18541', 'c8909a57-6ddb-4585-be00-e707c5b4f262', (SELECT COALESCE(MAX("Sequence"),0)+1 FROM ${mjSchema}."ApplicationEntity" WHERE "ApplicationID" = '891E92FE-561A-4FED-8EDC-E2D96FB18541'), NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Types for role UI */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('c8909a57-6ddb-4585-be00-e707c5b4f262', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Types for role Developer */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('c8909a57-6ddb-4585-be00-e707c5b4f262', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Types for role Integration */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('c8909a57-6ddb-4585-be00-e707c5b4f262', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());
...
INSERT INTO ${mjSchema}."ApplicationEntity"
                                       ("ApplicationID", "EntityID", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                       ('891E92FE-561A-4FED-8EDC-E2D96FB18541', '5deb0b11-ed6c-48b3-9200-f4441396c5e2', (SELECT COALESCE(MAX("Sequence"),0)+1 FROM ${mjSchema}."ApplicationEntity" WHERE "ApplicationID" = '891E92FE-561A-4FED-8EDC-E2D96FB18541'), NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contracts for role UI */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('5deb0b11-ed6c-48b3-9200-f4441396c5e2', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contracts for role Developer */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('5deb0b11-ed6c-48b3-9200-f4441396c5e2', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contracts for role Integration */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('5deb0b11-ed6c-48b3-9200-f4441396c5e2', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());
...
INSERT INTO ${mjSchema}."ApplicationEntity"
                                       ("ApplicationID", "EntityID", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                       ('891E92FE-561A-4FED-8EDC-E2D96FB18541', 'b05a480f-f7c5-4d45-8ea3-c90e9a14f225', (SELECT COALESCE(MAX("Sequence"),0)+1 FROM ${mjSchema}."ApplicationEntity" WHERE "ApplicationID" = '891E92FE-561A-4FED-8EDC-E2D96FB18541'), NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Template Modifications for role UI */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('b05a480f-f7c5-4d45-8ea3-c90e9a14f225', 'E0AFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 0, 0, 0, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Template Modifications for role Developer */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('b05a480f-f7c5-4d45-8ea3-c90e9a14f225', 'DEAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());

/* SQL generated to add new permission for entity MJ_BizApps_Contracts: Contract Template Modifications for role Integration */

INSERT INTO ${mjSchema}."EntityPermission"
                                                   ("EntityID", "RoleID", "CanRead", "CanCreate", "CanUpdate", "CanDelete", "__mj_CreatedAt", "__mj_UpdatedAt") VALUES
                                                   ('b05a480f-f7c5-4d45-8ea3-c90e9a14f225', 'DFAFCCEC-6A37-EF11-86D4-000D3A4E707E', 1, 1, 1, 1, NOW(), NOW());

/* SQL text to update existing entities from schema */

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts."ContractTemplateProvision" */
UPDATE "__mj_BizAppsContracts"."ContractTemplateProvision" SET "__mj_CreatedAt" = NOW() WHERE "__mj_CreatedAt" IS NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.ContractTemplateProvision */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateProvision" ALTER COLUMN "__mj_CreatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."ContractTemplateProvision"
  ALTER COLUMN "__mj_CreatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts."ContractTemplateProvision" */
UPDATE "__mj_BizAppsContracts"."ContractTemplateProvision" SET "__mj_UpdatedAt" = NOW() WHERE "__mj_UpdatedAt" IS NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.ContractTemplateProvision */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateProvision" ALTER COLUMN "__mj_UpdatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."ContractTemplateProvision"
  ALTER COLUMN "__mj_UpdatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts."ContractTemplateModification" */
UPDATE "__mj_BizAppsContracts"."ContractTemplateModification" SET "__mj_CreatedAt" = NOW() WHERE "__mj_CreatedAt" IS NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.ContractTemplateModification */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateModification" ALTER COLUMN "__mj_CreatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."ContractTemplateModification"
  ALTER COLUMN "__mj_CreatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts."ContractTemplateModification" */
UPDATE "__mj_BizAppsContracts"."ContractTemplateModification" SET "__mj_UpdatedAt" = NOW() WHERE "__mj_UpdatedAt" IS NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.ContractTemplateModification */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateModification" ALTER COLUMN "__mj_UpdatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."ContractTemplateModification"
  ALTER COLUMN "__mj_UpdatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts."ContractTemplateType" */
UPDATE "__mj_BizAppsContracts"."ContractTemplateType" SET "__mj_CreatedAt" = NOW() WHERE "__mj_CreatedAt" IS NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.ContractTemplateType */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateType" ALTER COLUMN "__mj_CreatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."ContractTemplateType"
  ALTER COLUMN "__mj_CreatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts."ContractTemplateType" */
UPDATE "__mj_BizAppsContracts"."ContractTemplateType" SET "__mj_UpdatedAt" = NOW() WHERE "__mj_UpdatedAt" IS NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.ContractTemplateType */
ALTER TABLE __mj_BizAppsContracts."ContractTemplateType" ALTER COLUMN "__mj_UpdatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."ContractTemplateType"
  ALTER COLUMN "__mj_UpdatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts."ContractTemplate" */
UPDATE "__mj_BizAppsContracts"."ContractTemplate" SET "__mj_CreatedAt" = NOW() WHERE "__mj_CreatedAt" IS NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.ContractTemplate */
ALTER TABLE __mj_BizAppsContracts."ContractTemplate" ALTER COLUMN "__mj_CreatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."ContractTemplate"
  ALTER COLUMN "__mj_CreatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts."ContractTemplate" */
UPDATE "__mj_BizAppsContracts"."ContractTemplate" SET "__mj_UpdatedAt" = NOW() WHERE "__mj_UpdatedAt" IS NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.ContractTemplate */
ALTER TABLE __mj_BizAppsContracts."ContractTemplate" ALTER COLUMN "__mj_UpdatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."ContractTemplate"
  ALTER COLUMN "__mj_UpdatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts."ContractType" */
UPDATE "__mj_BizAppsContracts"."ContractType" SET "__mj_CreatedAt" = NOW() WHERE "__mj_CreatedAt" IS NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.ContractType */
ALTER TABLE __mj_BizAppsContracts."ContractType" ALTER COLUMN "__mj_CreatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."ContractType"
  ALTER COLUMN "__mj_CreatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts."ContractType" */
UPDATE "__mj_BizAppsContracts"."ContractType" SET "__mj_UpdatedAt" = NOW() WHERE "__mj_UpdatedAt" IS NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.ContractType */
ALTER TABLE __mj_BizAppsContracts."ContractType" ALTER COLUMN "__mj_UpdatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."ContractType"
  ALTER COLUMN "__mj_UpdatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts."Contract" */
UPDATE "__mj_BizAppsContracts"."Contract" SET "__mj_CreatedAt" = NOW() WHERE "__mj_CreatedAt" IS NULL;

/* SQL text to add special date field __mj_CreatedAt to entity __mj_BizAppsContracts.Contract */
ALTER TABLE __mj_BizAppsContracts."Contract" ALTER COLUMN "__mj_CreatedAt" SET NOT NULL;

ALTER TABLE __mj_BizAppsContracts."Contract"
  ALTER COLUMN "__mj_CreatedAt" SET DEFAULT NOW();

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts."Contract" */
UPDATE "__mj_BizAppsContracts"."Contract" SET "__mj_UpdatedAt" = NOW() WHERE "__mj_UpdatedAt" IS NULL;

/* SQL text to add special date field __mj_UpdatedAt to entity __mj_BizAppsContracts.Contract */
ALTER TABLE __mj_BizAppsContracts."Contract" ALTER COLUMN "__mj_UpdatedAt" SET NOT NULL;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'da55d974-f70e-42d0-a12a-04f2efd46a85' OR ("EntityID" = '317DF592-8C20-473D-B097-2AB239877438' AND "Name" = 'ID')
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'fd673fee-72ab-4109-89b1-db5bcee9eb3e' OR ("EntityID" = '317DF592-8C20-473D-B097-2AB239877438' AND "Name" = 'ContractTemplateID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'cfb7315f-8759-4728-bd30-faae93f97106' OR ("EntityID" = '317DF592-8C20-473D-B097-2AB239877438' AND "Name" = 'ProvisionNumber')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'ce9ce69a-95cf-4cf0-bda8-f5f5e661a40b' OR ("EntityID" = '317DF592-8C20-473D-B097-2AB239877438' AND "Name" = 'Title')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'd2cd9029-4db4-4ad1-85a2-abbfda35eafd' OR ("EntityID" = '317DF592-8C20-473D-B097-2AB239877438' AND "Name" = 'ProvisionText')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '1bfda475-470f-4f3c-8b5d-b0dbdced2ee3' OR ("EntityID" = '317DF592-8C20-473D-B097-2AB239877438' AND "Name" = 'Description')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '2e082ebc-4a00-4c39-8f6d-f7b680f5b345' OR ("EntityID" = '317DF592-8C20-473D-B097-2AB239877438' AND "Name" = 'ProvisionSortKey')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '6b098c7f-9119-4c60-94b5-ca2aca14309f' OR ("EntityID" = '317DF592-8C20-473D-B097-2AB239877438' AND "Name" = '__mj_CreatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '9f515edd-be69-4955-9c10-eb1819ddfd2c' OR ("EntityID" = '317DF592-8C20-473D-B097-2AB239877438' AND "Name" = '__mj_UpdatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '4796bc59-bf1a-41cf-83b5-29e8f8880c47' OR ("EntityID" = 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225' AND "Name" = 'ID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '982e307b-667c-4955-99de-f9a96fab2cb2' OR ("EntityID" = 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225' AND "Name" = 'ContractID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '0864cb7f-e532-402f-9f16-102ec14993c6' OR ("EntityID" = 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225' AND "Name" = 'ContractTemplateProvisionID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '0d2fc779-82ca-4d68-a711-3d871a356164' OR ("EntityID" = 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225' AND "Name" = 'ModificationText')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '87bb27cb-98b7-4704-bdc5-7871f8f394eb' OR ("EntityID" = 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225' AND "Name" = 'Notes')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '18518499-1dd3-4369-bd76-59b62eeba5b8' OR ("EntityID" = 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225' AND "Name" = '__mj_CreatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '54072096-c4e2-450c-97fa-bf162e2485d6' OR ("EntityID" = 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225' AND "Name" = '__mj_UpdatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'b592f895-7e87-480a-8663-9d3c70f812d5' OR ("EntityID" = '4E3F97BE-E196-4CC0-9B5D-CC50DE8967A0' AND "Name" = 'ID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'eece216e-ec2b-4630-9e17-3fcde668f32a' OR ("EntityID" = '4E3F97BE-E196-4CC0-9B5D-CC50DE8967A0' AND "Name" = 'Name')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '3ec31ca1-a410-4a25-bb23-1e668a16a125' OR ("EntityID" = '4E3F97BE-E196-4CC0-9B5D-CC50DE8967A0' AND "Name" = 'Description')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '0e2ab42b-29f2-4151-a424-aba78bba163b' OR ("EntityID" = '4E3F97BE-E196-4CC0-9B5D-CC50DE8967A0' AND "Name" = 'Status')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'e7d55020-c93e-46b9-89e5-19088cbedb0a' OR ("EntityID" = '4E3F97BE-E196-4CC0-9B5D-CC50DE8967A0' AND "Name" = '__mj_CreatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '26168480-7c59-4436-b954-4979f44f7014' OR ("EntityID" = '4E3F97BE-E196-4CC0-9B5D-CC50DE8967A0' AND "Name" = '__mj_UpdatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'a8bf5461-4a41-4388-8761-50b79fc598b4' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = 'ID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '1fc39118-f7f8-4ba7-9940-f341e35f4fdb' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = 'Name')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '7b8ec82e-cf52-4f4c-980d-47a15194ea12' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = 'ContractTemplateTypeID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'd4e48fff-2f10-4e2e-a036-4d98bdafca99' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = 'VersionLabel')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'd20b1f02-4f4b-4a8e-894d-4d74f32a6282' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = 'IntroducedDate')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '5f27fb9a-a089-46ce-a332-f7e7de745bcf' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = 'SourceURL')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '7f9a6927-ca1d-441b-9682-7035c95393d8' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = 'Description')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'e84e1c35-41c9-4a59-8ad2-6d426fdb7e6b' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = 'Status')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'e586db3a-8fca-424f-bb0f-ae34be10c686' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = '__mj_CreatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'b0e8e57c-69a5-4a3f-bad2-ccbf75f2ff30' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = '__mj_UpdatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '9c8643d3-2b82-41a6-80f6-d29abb68d1cb' OR ("EntityID" = 'C8909A57-6DDB-4585-BE00-E707C5B4F262' AND "Name" = 'ID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '84119ad2-cba8-466b-b20a-8a94c20fce3f' OR ("EntityID" = 'C8909A57-6DDB-4585-BE00-E707C5B4F262' AND "Name" = 'Name')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '46b195b4-ea25-41a4-bb78-83b2014a930c' OR ("EntityID" = 'C8909A57-6DDB-4585-BE00-E707C5B4F262' AND "Name" = 'Description')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '62afa042-4658-4d78-b9c3-1bdd0b3997d4' OR ("EntityID" = 'C8909A57-6DDB-4585-BE00-E707C5B4F262' AND "Name" = 'RequiresExecutedDocument')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '59601a28-9aed-4e62-8b3b-ea21b769b9eb' OR ("EntityID" = 'C8909A57-6DDB-4585-BE00-E707C5B4F262' AND "Name" = 'Status')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'd252cc6d-3196-4616-aaef-93ffc7ce6887' OR ("EntityID" = 'C8909A57-6DDB-4585-BE00-E707C5B4F262' AND "Name" = 'MustBeRoot')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '04ba23cd-ec7a-495b-81df-47474ef8c0eb' OR ("EntityID" = 'C8909A57-6DDB-4585-BE00-E707C5B4F262' AND "Name" = 'MustBeChild')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '444fc85a-bd7a-4967-8633-a4e1f8acb4ce' OR ("EntityID" = 'C8909A57-6DDB-4585-BE00-E707C5B4F262' AND "Name" = 'TemplateRequired')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '6a869a40-c89a-43f5-bc80-94a104e9fc46' OR ("EntityID" = 'C8909A57-6DDB-4585-BE00-E707C5B4F262' AND "Name" = '__mj_CreatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '68821111-317c-4ab8-922e-f1ec8aea0973' OR ("EntityID" = 'C8909A57-6DDB-4585-BE00-E707C5B4F262' AND "Name" = '__mj_UpdatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '04e8aa9d-c2dc-489d-b081-75c4e6ddfa6b' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'ID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '8677055b-2482-4250-98c1-afc3dae57393' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'ContractNumber')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'df26a6b1-eb6c-42d8-b236-cd13f58c9b78' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'ContractTypeID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'bad7aa2f-ee2b-430a-b182-b7e4b7e09f8a' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'CompanyID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'f11c9543-f483-4bed-a9ce-3e7659d24011' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'CustomerOrganizationID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'd47233ed-0ebf-4329-b270-99f70589cd7f' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'PrimaryContactPersonID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'b4e3a6bf-a9c0-4005-b759-f7623fd5a7fa' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'ContractTemplateID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '316a9f07-54f1-4038-862a-c25a2084f274' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'CreatingEntityID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '611650f5-bfc3-4809-b9b1-80ac9979b450' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'CreatingRecordID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '6db0692a-42cd-4ac5-a43b-49ecc81ef370' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'ParentContractID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '44bc44ef-a6f2-4630-a899-487ce0e3cc56' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'SupersededByContractID')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '131ce82f-ac93-4dcf-95c0-3ea4fc681c2c' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'SigningProviderURL')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '5605ab79-a11a-4561-8b34-b7567a36f27a' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'EffectiveDate')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '9ed4a8cc-e0b8-4880-945a-4bd6dd6368c6' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'ExecutedDate')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '343becbd-079b-443a-998c-2e7ddccd8a01' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'EndDate')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'd312f0c4-ad4d-4f0b-b54a-1051ec735464' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'TerminatedDate')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '8b3c517c-ff01-4121-a740-632df75f3c05' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'AutoRenew')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '573064ac-38a8-42a2-95b2-ccbd605004ea' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'RenewalNoticeDays')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'c6464adc-6683-4d4b-aa7a-64f9e052d225' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'CancellationWindowDays')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '3b2625e1-c5ab-462c-aa7e-533c5f40646d' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'AnnualIncreasePercent')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'd54ddebd-615b-4d29-a995-246c3c0f7408' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'HasModifications')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '30b733e2-70e1-4d55-ba83-73fedba848fa' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'Description')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '68e70227-d818-4f11-8fe4-553f5c84be53' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'Notes')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '7c14348e-69de-4f66-b62c-99c0a7e415af' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = '__mj_CreatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '0eba35ec-fb3d-4978-8650-fc6229a9180e' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = '__mj_UpdatedAt')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
INSERT INTO ${mjSchema}."EntityFieldValue"
                                    ...
                                    VALUES
                                       ('217e9e49-0b4f-44c1-9f68-035f69e7a7bd', '0E2AB42B-29F2-4151-A424-ABA78BBA163B', 1, 'Active', 'Active', NOW(), NOW());
...
INSERT INTO ${mjSchema}."EntityFieldValue"
                                       ("ID", "EntityFieldID", "Sequence", "Value", "Code", "__mj_CreatedAt", "__mj_UpdatedAt")
                                    VALUES
                                       ('3ba9d65c-2cc4-4b0b-9be7-376aaab7234b', '0E2AB42B-29F2-4151-A424-ABA78BBA163B', 2, 'Inactive', 'Inactive', NOW(), NOW());
...
INSERT INTO ${mjSchema}."EntityFieldValue"
                                       ("ID", "EntityFieldID", "Sequence", "Value", "Code", "__mj_CreatedAt", "__mj_UpdatedAt")
                                    VALUES
                                       ('0b3ec358-4aec-4e2c-9361-94626326c8d6', 'E84E1C35-41C9-4A59-8AD2-6D426FDB7E6B', 1, 'Draft', 'Draft', NOW(), NOW());
...
INSERT INTO ${mjSchema}."EntityFieldValue"
                                       ("ID", "EntityFieldID", "Sequence", "Value", "Code", "__mj_CreatedAt", "__mj_UpdatedAt")
                                    VALUES
                                       ('ad6ada75-99df-45c1-b852-5c3aebaf6220', 'E84E1C35-41C9-4A59-8AD2-6D426FDB7E6B', 2, 'Published', 'Published', NOW(), NOW());
...
INSERT INTO ${mjSchema}."EntityFieldValue"
                                       ("ID", "EntityFieldID", "Sequence", "Value", "Code", "__mj_CreatedAt", "__mj_UpdatedAt")
                                    VALUES
                                       ('6b1d3830-0e26-4457-b945-b8c05221c54e', '59601A28-9AED-4E62-8B3B-EA21B769B9EB', 1, 'Active', 'Active', NOW(), NOW());
...
INSERT INTO ${mjSchema}."EntityFieldValue"
                                       ("ID", "EntityFieldID", "Sequence", "Value", "Code", "__mj_CreatedAt", "__mj_UpdatedAt")
                                    VALUES
                                       ('39fba98a-d6e1-4f28-bb74-5f40e0e43f3f', '59601A28-9AED-4E62-8B3B-EA21B769B9EB', 2, 'Inactive', 'Inactive', NOW(), NOW());
...
BEGIN
    IF NOT EXISTS (
        ...
        VALUES ('82939a7c-51c9-4723-bcd7-3caecf976536', '317DF592-8C20-473D-B097-2AB239877438', 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225', 'ContractTemplateProvisionID', 'One To Many', 1, 1, 1, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('aa2aa995-a5fa-4565-8355-90e26f36365d', 'D4238F34-2837-EF11-86D4-6045BDEE16E6', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', 'CompanyID', 'One To Many', 1, 1, 7, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('7fa39de0-72c9-4956-ad6c-476397a1aeac', 'E0238F34-2837-EF11-86D4-6045BDEE16E6', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', 'CreatingEntityID', 'One To Many', 1, 1, 77, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('c674fabb-6df9-434e-90c0-99ec631f234b', 'C70448F9-9792-41D7-A82C-784B66429D54', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', 'CustomerOrganizationID', 'One To Many', 1, 1, 5, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('05bfcb9a-898f-4d3b-9341-9c2a5fc9c996', '4E3F97BE-E196-4CC0-9B5D-CC50DE8967A0', '731F2890-1415-40DE-9073-D22EA23392B3', 'ContractTemplateTypeID', 'One To Many', 1, 1, 1, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('e415e5bf-fcaa-49a6-bf33-ef3bc2d0d865', '731F2890-1415-40DE-9073-D22EA23392B3', '317DF592-8C20-473D-B097-2AB239877438', 'ContractTemplateID', 'One To Many', 1, 1, 1, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('7790db07-7e7f-4f4a-a661-fac992fa5cf7', '731F2890-1415-40DE-9073-D22EA23392B3', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', 'ContractTemplateID', 'One To Many', 1, 1, 2, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('6f16093e-ba7a-44c9-8e06-901f3383c7dc', '7A94ADA9-7880-4FAE-97D8-DB0E934C3F5F', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', 'PrimaryContactPersonID', 'One To Many', 1, 1, 4, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('37d5be77-a5a5-47f3-b217-e5ae72daafe9', 'C8909A57-6DDB-4585-BE00-E707C5B4F262', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', 'ContractTypeID', 'One To Many', 1, 1, 1, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('0a972e9e-abaa-47fe-8dd7-90d1a60dc25d', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225', 'ContractID', 'One To Many', 1, 1, 1, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('3b056bc8-b985-403a-9dcc-accef921c323', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', 'SupersededByContractID', 'One To Many', 1, 1, 2, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO ${mjSchema}."EntityRelationship" ("ID", "EntityID", "RelatedEntityID", "RelatedEntityJoinField", "Type", "BundleInAPI", "DisplayInForm", "Sequence", "__mj_CreatedAt", "__mj_UpdatedAt")
        VALUES ('e45a646d-9a56-45e8-9c64-5583e38654c2', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', '5DEB0B11-ED6C-48B3-9200-F4441396C5E2', 'ParentContractID', 'One To Many', 1, 1, 3, NOW(), NOW());
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'f56ab0cb-ec8f-429a-a33f-beddc6bb9f67' OR ("EntityID" = '317DF592-8C20-473D-B097-2AB239877438' AND "Name" = 'ContractTemplate')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '1e89d300-7f0d-4c94-9ba2-65f616951731' OR ("EntityID" = '731F2890-1415-40DE-9073-D22EA23392B3' AND "Name" = 'ContractTemplateType')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '14bda941-ce85-4a14-8fdc-3681b8c52418' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'ContractType')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'a2b9a232-351c-4cf9-a050-6f059f146806' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'Company')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '8fbc1aac-1342-4584-991f-aab1c31ce673' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'CustomerOrganization')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '2999f51a-9170-4028-b142-2f33d7e056ed' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'PrimaryContactPerson')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = '3df1fccc-6c4f-4cef-abec-836517ba655a' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'ContractTemplate')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM ${mjSchema}."EntityField" WHERE "ID" = 'b35327d2-0775-4cd2-9d4a-0fa1a2c98aa0' OR ("EntityID" = '5DEB0B11-ED6C-48B3-9200-F4441396C5E2' AND "Name" = 'CreatingEntity')
    ) THEN
        INSERT INTO ${mjSchema}."EntityField"
        (
        "ID",
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'B592F895-7E87-480A-8663-9D3C70F812D5' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'EECE216E-EC2B-4630-9E17-3FCDE668F32A' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '3EC31CA1-A410-4A25-BB23-1E668A16A125' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '0E2AB42B-29F2-4151-A424-ABA78BBA163B' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'E7D55020-C93E-46B9-89E5-19088CBEDB0A' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '26168480-7C59-4436-B954-4979F44F7014' AND "AutoUpdateCategory" = TRUE;

/* Set entity icon to fa fa-file-contract */

UPDATE ${mjSchema}."Entity"
               SET "Icon" = 'fa fa-file-contract', "__mj_UpdatedAt" = NOW()
               WHERE "ID" = '4E3F97BE-E196-4CC0-9B5D-CC50DE8967A0';

/* Insert FieldCategoryInfo setting for entity */

INSERT INTO ${mjSchema}."EntitySetting" ("ID", "EntityID", "Name", "Value", "__mj_CreatedAt", "__mj_UpdatedAt")
               VALUES ('0b578442-b41f-484b-827e-d47e4013c7bb', '4E3F97BE-E196-4CC0-9B5D-CC50DE8967A0', 'FieldCategoryInfo', '{"Contract Template Details":{"icon":"fa fa-file-contract","description":"Information defining the specific type of contract template"},"System Metadata":{"icon":"fa fa-cog","description":"System-managed audit and tracking fields"}}', NOW(), NOW());

/* Insert FieldCategoryIcons setting (legacy) */

INSERT INTO ${mjSchema}."EntitySetting" ("ID", "EntityID", "Name", "Value", "__mj_CreatedAt", "__mj_UpdatedAt")
               VALUES ('1296ce7e-6406-4540-887c-dad2b35d435e', '4E3F97BE-E196-4CC0-9B5D-CC50DE8967A0', 'FieldCategoryIcons', '{"Contract Template Details":"fa fa-file-contract","System Metadata":"fa fa-cog"}', NOW(), NOW());
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '4796BC59-BF1A-41CF-83B5-29E8F8880C47' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '982E307B-667C-4955-99DE-F9A96FAB2CB2' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '0864CB7F-E532-402F-9F16-102EC14993C6' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '0D2FC779-82CA-4D68-A711-3D871A356164' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '87BB27CB-98B7-4704-BDC5-7871F8F394EB' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '18518499-1DD3-4369-BD76-59B62EEBA5B8' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '54072096-C4E2-450C-97FA-BF162E2485D6' AND "AutoUpdateCategory" = TRUE;
...
INSERT INTO ${mjSchema}."EntitySetting" ("ID", "EntityID", "Name", "Value", "__mj_CreatedAt", "__mj_UpdatedAt")
               VALUES ('7c40ba9f-d702-4e58-a74f-51e0db251f13', 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225', 'FieldCategoryInfo', '{"Contract Association":{"icon":"fa fa-link","description":"Links the modification to the parent contract and specific template provision."},"Modification Details":{"icon":"fa fa-edit","description":"The specific text changes and supporting notes for the contract modification."},"System Metadata":{"icon":"fa fa-cog","description":"System-managed audit and tracking fields."}}', NOW(), NOW());

/* Insert FieldCategoryIcons setting (legacy) */

INSERT INTO ${mjSchema}."EntitySetting" ("ID", "EntityID", "Name", "Value", "__mj_CreatedAt", "__mj_UpdatedAt")
               VALUES ('0e258280-451a-4b0c-bcc4-19ae5309b564', 'B05A480F-F7C5-4D45-8EA3-C90E9A14F225', 'FieldCategoryIcons', '{"Contract Association":"fa fa-link","Modification Details":"fa fa-edit","System Metadata":"fa fa-cog"}', NOW(), NOW());
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '9C8643D3-2B82-41A6-80F6-D29ABB68D1CB' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '84119AD2-CBA8-466B-B20A-8A94C20FCE3F' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '46B195B4-EA25-41A4-BB78-83B2014A930C' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '59601A28-9AED-4E62-8B3B-EA21B769B9EB' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '62AFA042-4658-4D78-B9C3-1BDD0B3997D4' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'D252CC6D-3196-4616-AAEF-93FFC7CE6887' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '04BA23CD-EC7A-495B-81DF-47474EF8C0EB' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '444FC85A-BD7A-4967-8633-A4E1F8ACB4CE' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '6A869A40-C89A-43F5-BC80-94A104E9FC46' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '68821111-317C-4AB8-922E-F1EC8AEA0973' AND "AutoUpdateCategory" = TRUE;
...
INSERT INTO ${mjSchema}."EntitySetting" ("ID", "EntityID", "Name", "Value", "__mj_CreatedAt", "__mj_UpdatedAt")
               VALUES ('d2d62a86-3c4a-442a-bc2c-a0498b5f5632', 'C8909A57-6DDB-4585-BE00-E707C5B4F262', 'FieldCategoryInfo', '{"Contract Type Details":{"icon":"fa fa-info-circle","description":"Basic identification and status information for the contract type"},"Configuration Rules":{"icon":"fa fa-cogs","description":"Business logic and constraints governing contract behavior and placement"},"System Metadata":{"icon":"fa fa-cog","description":"System-managed audit and tracking fields"}}', NOW(), NOW());

/* Insert FieldCategoryIcons setting (legacy) */

INSERT INTO ${mjSchema}."EntitySetting" ("ID", "EntityID", "Name", "Value", "__mj_CreatedAt", "__mj_UpdatedAt")
               VALUES ('14088b52-f54b-47e4-bc16-9c4f325c7450', 'C8909A57-6DDB-4585-BE00-E707C5B4F262', 'FieldCategoryIcons', '{"Contract Type Details":"fa fa-info-circle","Configuration Rules":"fa fa-cogs","System Metadata":"fa fa-cog"}', NOW(), NOW());
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'DA55D974-F70E-42D0-A12A-04F2EFD46A85' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'FD673FEE-72AB-4109-89B1-DB5BCEE9EB3E' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'F56AB0CB-EC8F-429A-A33F-BEDDC6BB9F67' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'CFB7315F-8759-4728-BD30-FAAE93F97106' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'CE9CE69A-95CF-4CF0-BDA8-F5F5E661A40B' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'D2CD9029-4DB4-4AD1-85A2-ABBFDA35EAFD' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '1BFDA475-470F-4F3C-8B5D-B0DBDCED2EE3' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '2E082EBC-4A00-4C39-8F6D-F7B680F5B345' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '6B098C7F-9119-4C60-94B5-CA2ACA14309F' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '9F515EDD-BE69-4955-9C10-EB1819DDFD2C' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'A8BF5461-4A41-4388-8761-50B79FC598B4' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '1FC39118-F7F8-4BA7-9940-F341E35F4FDB' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '7B8EC82E-CF52-4F4C-980D-47A15194EA12' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '1E89D300-7F0D-4C94-9BA2-65F616951731' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'D4E48FFF-2F10-4E2E-A036-4D98BDAFCA99' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '7F9A6927-CA1D-441B-9682-7035C95393D8' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'D20B1F02-4F4B-4A8E-894D-4D74F32A6282' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '5F27FB9A-A089-46CE-A332-F7E7DE745BCF' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'E84E1C35-41C9-4A59-8AD2-6D426FDB7E6B' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'E586DB3A-8FCA-424F-BB0F-AE34BE10C686' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'B0E8E57C-69A5-4A3F-BAD2-CCBF75F2FF30' AND "AutoUpdateCategory" = TRUE;
...
INSERT INTO ${mjSchema}."EntitySetting" ("ID", "EntityID", "Name", "Value", "__mj_CreatedAt", "__mj_UpdatedAt")
               VALUES ('04cd7a19-f678-4e64-a3a3-21af4d94c378', '317DF592-8C20-473D-B097-2AB239877438', 'FieldCategoryIcons', '{"Template Association":"fa fa-link","Provision Details":"fa fa-align-left","System Metadata":"fa fa-cog"}', NOW(), NOW());

/* Insert FieldCategoryIcons setting (legacy) */

INSERT INTO ${mjSchema}."EntitySetting" ("ID", "EntityID", "Name", "Value", "__mj_CreatedAt", "__mj_UpdatedAt")
               VALUES ('4fca29d1-19bb-45a4-ada3-2a2c25d24d78', '731F2890-1415-40DE-9073-D22EA23392B3', 'FieldCategoryIcons', '{"Template Details":"fa fa-info-circle","Lifecycle and Access":"fa fa-history","System Metadata":"fa fa-cog"}', NOW(), NOW());
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '04E8AA9D-C2DC-489D-B081-75C4E6DDFA6B' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '8677055B-2482-4250-98C1-AFC3DAE57393' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'DF26A6B1-EB6C-42D8-B236-CD13F58C9B78' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '14BDA941-CE85-4A14-8FDC-3681B8C52418' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'BAD7AA2F-EE2B-430A-B182-B7E4B7E09F8A' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'A2B9A232-351C-4CF9-A050-6F059F146806' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'F11C9543-F483-4BED-A9CE-3E7659D24011' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '8FBC1AAC-1342-4584-991F-AAB1C31CE673' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'D47233ED-0EBF-4329-B270-99F70589CD7F' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '2999F51A-9170-4028-B142-2F33D7E056ED' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'B4E3A6BF-A9C0-4005-B759-F7623FD5A7FA' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '3DF1FCCC-6C4F-4CEF-ABEC-836517BA655A' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '316A9F07-54F1-4038-862A-C25A2084F274' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'B35327D2-0775-4CD2-9D4A-0FA1A2C98AA0' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '611650F5-BFC3-4809-B9B1-80AC9979B450' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '6DB0692A-42CD-4AC5-A43B-49ECC81EF370' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '44BC44EF-A6F2-4630-A899-487CE0E3CC56' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '131CE82F-AC93-4DCF-95C0-3EA4FC681C2C' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '5605AB79-A11A-4561-8B34-B7567A36F27A' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '9ED4A8CC-E0B8-4880-945A-4BD6DD6368C6' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '343BECBD-079B-443A-998C-2E7DDCCD8A01' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'D312F0C4-AD4D-4F0B-B54A-1051EC735464' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '8B3C517C-FF01-4121-A740-632DF75F3C05' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '573064AC-38A8-42A2-95B2-CCBD605004EA' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'C6464ADC-6683-4D4B-AA7A-64F9E052D225' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '3B2625E1-C5AB-462C-AA7E-533C5F40646D' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = 'D54DDEBD-615B-4D29-A995-246C3C0F7408' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '30B733E2-70E1-4D55-BA83-73FEDBA848FA' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '68E70227-D818-4F11-8FE4-553F5C84BE53' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '7C14348E-69DE-4F66-B62C-99C0A7E415AF' AND "AutoUpdateCategory" = TRUE;
...
SET 
   ...
   "CodeType" = NULL
WHERE 
   "ID" = '0EBA35EC-FB3D-4978-8650-FC6229A9180E' AND "AutoUpdateCategory" = TRUE;
...
INSERT INTO ${mjSchema}."GeneratedCode" ("CategoryID", "GeneratedByModelID", "GeneratedAt", "Language", "Status", "Source", "Code", "Description", "Name", "LinkedEntityID", "LinkedRecordPrimaryKey")
                      VALUES ((SELECT "ID" FROM ${mjSchema}."vwGeneratedCodeCategories" WHERE "Name"='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', NOW(), 'TypeScript', 'Approved', '(LENGTH(ltrim(rtrim([ModificationText])))>(0))', 'public ValidateModificationTextNotEmpty(result: ValidationResult) {
...
INSERT INTO ${mjSchema}."GeneratedCode" ("CategoryID", "GeneratedByModelID", "GeneratedAt", "Language", "Status", "Source", "Code", "Description", "Name", "LinkedEntityID", "LinkedRecordPrimaryKey")
                      VALUES ((SELECT "ID" FROM ${mjSchema}."vwGeneratedCodeCategories" WHERE "Name"='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', NOW(), 'TypeScript', 'Approved', '(LENGTH(ltrim(rtrim([ProvisionText])))>(0))', 'public ValidateProvisionTextNotEmpty(result: ValidationResult) {
...
INSERT INTO ${mjSchema}."GeneratedCode" ("CategoryID", "GeneratedByModelID", "GeneratedAt", "Language", "Status", "Source", "Code", "Description", "Name", "LinkedEntityID", "LinkedRecordPrimaryKey")
                      VALUES ((SELECT "ID" FROM ${mjSchema}."vwGeneratedCodeCategories" WHERE "Name"='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', NOW(), 'TypeScript', 'Approved', '(NOT ([MustBeRoot]=TRUE AND [MustBeChild]=TRUE))', 'public ValidateRootAndChildExclusivity(result: ValidationResult) {
...
INSERT INTO ${mjSchema}."GeneratedCode" ("CategoryID", "GeneratedByModelID", "GeneratedAt", "Language", "Status", "Source", "Code", "Description", "Name", "LinkedEntityID", "LinkedRecordPrimaryKey")
                      VALUES ((SELECT "ID" FROM ${mjSchema}."vwGeneratedCodeCategories" WHERE "Name"='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', NOW(), 'TypeScript', 'Approved', '([AnnualIncreasePercent] IS NULL OR [AnnualIncreasePercent]>=(0))', 'public ValidateAnnualIncreasePercentNonNegative(result: ValidationResult) {
...
INSERT INTO ${mjSchema}."GeneratedCode" ("CategoryID", "GeneratedByModelID", "GeneratedAt", "Language", "Status", "Source", "Code", "Description", "Name", "LinkedEntityID", "LinkedRecordPrimaryKey")
                      VALUES ((SELECT "ID" FROM ${mjSchema}."vwGeneratedCodeCategories" WHERE "Name"='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', NOW(), 'TypeScript', 'Approved', '([CancellationWindowDays] IS NULL OR [CancellationWindowDays]>=(0))', 'public ValidateCancellationWindowDaysGreaterThanOrEqualToZero(result: ValidationResult) {
...
INSERT INTO ${mjSchema}."GeneratedCode" ("CategoryID", "GeneratedByModelID", "GeneratedAt", "Language", "Status", "Source", "Code", "Description", "Name", "LinkedEntityID", "LinkedRecordPrimaryKey")
                      VALUES ((SELECT "ID" FROM ${mjSchema}."vwGeneratedCodeCategories" WHERE "Name"='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', NOW(), 'TypeScript', 'Approved', '([RenewalNoticeDays] IS NULL OR [RenewalNoticeDays]>=(0))', 'public ValidateRenewalNoticeDaysGreaterThanOrEqualToZero(result: ValidationResult) {
...
INSERT INTO ${mjSchema}."GeneratedCode" ("CategoryID", "GeneratedByModelID", "GeneratedAt", "Language", "Status", "Source", "Code", "Description", "Name", "LinkedEntityID", "LinkedRecordPrimaryKey")
                      VALUES ((SELECT "ID" FROM ${mjSchema}."vwGeneratedCodeCategories" WHERE "Name"='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', NOW(), 'TypeScript', 'Approved', '([CreatingEntityID] IS NULL AND [CreatingRecordID] IS NULL OR [CreatingEntityID] IS NOT NULL AND [CreatingRecordID] IS NOT NULL)', 'public ValidateCreatingEntityAndRecordCoexistence(result: ValidationResult) {
...
INSERT INTO ${mjSchema}."GeneratedCode" ("CategoryID", "GeneratedByModelID", "GeneratedAt", "Language", "Status", "Source", "Code", "Description", "Name", "LinkedEntityID", "LinkedRecordPrimaryKey")
                      VALUES ((SELECT "ID" FROM ${mjSchema}."vwGeneratedCodeCategories" WHERE "Name"='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', NOW(), 'TypeScript', 'Approved', '([EndDate] IS NULL OR [EffectiveDate] IS NULL OR [EndDate]>=[EffectiveDate])', 'public ValidateEndDateAfterOrEqualToEffectiveDate(result: ValidationResult) {
...
INSERT INTO ${mjSchema}."GeneratedCode" ("CategoryID", "GeneratedByModelID", "GeneratedAt", "Language", "Status", "Source", "Code", "Description", "Name", "LinkedEntityID", "LinkedRecordPrimaryKey")
                      VALUES ((SELECT "ID" FROM ${mjSchema}."vwGeneratedCodeCategories" WHERE "Name"='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', NOW(), 'TypeScript', 'Approved', '([ParentContractID] IS NULL OR [ParentContractID]<>[ID])', 'public ValidateParentContractIDNotEqualToID(result: ValidationResult) {
...
INSERT INTO ${mjSchema}."GeneratedCode" ("CategoryID", "GeneratedByModelID", "GeneratedAt", "Language", "Status", "Source", "Code", "Description", "Name", "LinkedEntityID", "LinkedRecordPrimaryKey")
                      VALUES ((SELECT "ID" FROM ${mjSchema}."vwGeneratedCodeCategories" WHERE "Name"='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', NOW(), 'TypeScript', 'Approved', '([SupersededByContractID] IS NULL OR [SupersededByContractID]<>[ID])', 'public ValidateSupersededByContractIDNotEqualToID(result: ValidationResult) {
...
ALTER TABLE __mj_BizAppsContracts."ContractTemplate"
 ADD CONSTRAINT "FK_ContractTemplate_ContractTemplateType"
    FOREIGN KEY ("ContractTemplateTypeID") REFERENCES __mj_BizAppsContracts."ContractTemplateType"("ID") DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE __mj_BizAppsContracts."ContractTemplateProvision"
 ADD CONSTRAINT "FK_ContractTemplateProvision_ContractTemplate"
    FOREIGN KEY ("ContractTemplateID") REFERENCES __mj_BizAppsContracts."ContractTemplate"("ID") DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE __mj_BizAppsContracts."Contract"
 ADD CONSTRAINT "FK_Contract_ContractType"
    FOREIGN KEY ("ContractTypeID") REFERENCES __mj_BizAppsContracts."ContractType"("ID") DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE __mj_BizAppsContracts."Contract"
 ADD CONSTRAINT "FK_Contract_ParentContract"
    FOREIGN KEY ("ParentContractID") REFERENCES __mj_BizAppsContracts."Contract"("ID") DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE __mj_BizAppsContracts."Contract"
 ADD CONSTRAINT "FK_Contract_SupersededByContract"
    FOREIGN KEY ("SupersededByContractID") REFERENCES __mj_BizAppsContracts."Contract"("ID") DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE __mj_BizAppsContracts."ContractTemplateModification"
 ADD CONSTRAINT "FK_ContractTemplateModification_Contract"
    FOREIGN KEY ("ContractID") REFERENCES __mj_BizAppsContracts."Contract"("ID") DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE __mj_BizAppsContracts."ContractTemplateModification"
 ADD CONSTRAINT "FK_ContractTemplateModification_ContractTemplateProvision"
    FOREIGN KEY ("ContractTemplateProvisionID") REFERENCES __mj_BizAppsContracts."ContractTemplateProvision"("ID") DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE __mj_BizAppsContracts."Contract"
 ADD CONSTRAINT "FK_Contract_Company"
    FOREIGN KEY ("CompanyID") REFERENCES __mj."Company"("ID") DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE __mj_BizAppsContracts."Contract"
 ADD CONSTRAINT "FK_Contract_CustomerOrganization"
    FOREIGN KEY ("CustomerOrganizationID") REFERENCES __mj_BizAppsCommon."Organization"("ID") DEFERRABLE INITIALLY DEFERRED;

ALTER TABLE __mj_BizAppsContracts."Contract"
 ADD CONSTRAINT "FK_Contract_PrimaryContactPerson"
    FOREIGN KEY ("PrimaryContactPersonID") REFERENCES __mj_BizAppsCommon."Person"("ID") DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE __mj_BizAppsContracts."Contract"
 ADD CONSTRAINT "FK_Contract_CreatingEntity"
    FOREIGN KEY ("CreatingEntityID") REFERENCES __mj."Entity"("ID") DEFERRABLE INITIALLY DEFERRED;
...
DO $$ BEGIN GRANT SELECT ON __mj_BizAppsContracts."vwContractTemplateTypes" TO "cdp_UI", "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spCreateContractTemplateType" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spUpdateContractTemplateType" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spUpdateContractTemplateType" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT SELECT ON __mj_BizAppsContracts."vwContractTypes" TO "cdp_UI", "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spCreateContractType" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spUpdateContractType" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spUpdateContractType" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spDeleteContractTemplateType" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spDeleteContractType" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT SELECT ON __mj_BizAppsContracts."vwContractTemplateProvisions" TO "cdp_UI", "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spCreateContractTemplateProvision" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spUpdateContractTemplateProvision" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spUpdateContractTemplateProvision" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spDeleteContractTemplateProvision" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spCreateContractTemplate" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spUpdateContractTemplate" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spUpdateContractTemplate" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spDeleteContractTemplate" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spCreateContract" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spUpdateContract" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spUpdateContract" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN GRANT EXECUTE ON FUNCTION __mj_BizAppsContracts."spDeleteContract" TO "cdp_Developer", "cdp_Integration"; EXCEPTION WHEN others THEN NULL; END $$;
...
COMMENT ON TABLE __mj_BizAppsContracts."ContractTemplateType" IS 'The kind of standard agreement (Master Agreement, Statement of Work). A lookup TABLE rather than a CHECK because the list is additive at runtime and a business user should be able to add one without a migration. Carries no behaviour.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplateType"."Status" IS 'Active | Inactive. Retiring a type hides it from pickers without touching the templates that used it.';

COMMENT ON TABLE __mj_BizAppsContracts."ContractTemplate" IS 'One VERSION of a standard agreement — in practice the Master Agreement. Versions matter because each is published at its own dated URL that never goes away, so a customer stays bound to the text they signed. Carries no prose of its own: every clauses standard wording lives on its ContractTemplateProvision row.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplate"."VersionLabel" IS 'The version the document names itself, e.g. "v6". Free text, because it is the documents own label rather than something we derive.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplate"."IntroducedDate" IS 'When this version started being offered. NOT an effective date: a template becomes effective for a customer when THAT customer signs it, never on a calendar date. Naming it EffectiveDate would invite exactly the wrong query.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplate"."SourceURL" IS 'The dated public URL a customer can open to read the standard terms. NULLABLE: reachability is enforceable by nothing (a well-formed dead link passes any format check), and the real rule is "a URL OR an attached file" — the file half attaching through __mj.FileEntityRecordLink, which cannot reference a record that does not exist yet, so on CREATE it is unsatisfiable in principle. A template with neither is INCOMPLETE rather than invalid; the derived IsUsable column on vwContractTemplates is what says so.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplate"."Status" IS 'Publication lifecycle. ''Draft'' -- freely editable, provisions may be added, changed and removed, and a contract may not NEWLY reference it. ''Published'' -- the provisions are frozen against INSERT, UPDATE and DELETE by trg_ContractTemplateProvision_Immutability, and contracts may reference it. Publishing is ONE-WAY (enforced in ContractTemplateEntity): to change published terms, publish a new version -- that is what VersionLabel exists for. Existing references are never invalidated by this column; only new ones are policed, the same way ContractType.Status works.';

COMMENT ON TABLE __mj_BizAppsContracts."ContractTemplateProvision" IS 'The numbered clause list of a template version, and the home of all standard contract text. Hangs off ContractTemplate rather than standing alone because provision numbering belongs to a VERSION — the moment a new version renumbers, a single global list is wrong.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplateProvision"."ProvisionNumber" IS 'The clause number as the document writes it, e.g. "3.5(b)". Unique within its template.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplateProvision"."Title" IS 'The clause heading, e.g. "Limitation of Liability". This plus the number is what a person picks from.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplateProvision"."ProvisionText" IS 'The STANDARD wording of this clause. Read as a pair with ContractTemplateModification.ModificationText, which holds what a given contract says instead — a dispute needs the comparison, not either half.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplateProvision"."ProvisionSortKey" IS 'Collation key derived from ProvisionNumber: every run of digits zero-padded to six places, everything else upper-cased. Makes a plain SQL ORDER BY produce natural order (''1.9'' before ''1.10''), which ordering by ProvisionNumber cannot. READ-ONLY -- a persisted computed column; nobody should be able to set a sort key. Replaced the hand-maintained Sequence column, which had already collided in the seeded data.';

COMMENT ON TABLE __mj_BizAppsContracts."ContractType" IS 'The kind of paper: Order Form, Statement of Work, Payment Link, Change Order. A lookup TABLE for the same reason as ContractTemplateType.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractType"."RequiresExecutedDocument" IS 'Whether paper is ever expected for this kind of contract. No for a Payment Link, which has an implied agreement and no signature. This is what stops such a contract asking forever for a document that will never arrive: "awaiting the document" is DERIVED as requires-it AND no-linked-file, never stored and never a status value.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractType"."Status" IS 'Active | Inactive.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractType"."MustBeRoot" IS 'This type of contract may NOT name a ParentContractID -- it is a root agreement. Enforced in ContractEntityServer.ValidateAsync. Mutually exclusive with MustBeChild (CK_ContractType_RootOrChild); both false means no restriction on where in the tree this type may sit, which is the honest default.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractType"."MustBeChild" IS 'This type of contract MUST name a ParentContractID -- a Change Order that amends nothing is not a change order, and would never appear in the original agreement''s lineage. Enforced in ContractEntityServer.ValidateAsync. Mutually exclusive with MustBeRoot.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractType"."TemplateRequired" IS 'This type of contract must carry its own ContractTemplateID -- the standard terms it incorporates. On the TYPE rather than inferred from the placement flags, because ''where in the tree'' and ''does it need its own paper'' are different questions and a future type could want any combination.';

COMMENT ON TABLE __mj_BizAppsContracts."Contract" IS 'The signed agreement — one row per piece of signed (or implied) paper, and the centre of the app. Carries NO hard reference to a Deal: sales creates contracts, so sales depends on this app and a reference upward would invert the dependency graph. The link is the typed polymorphic pair CreatingEntityID + CreatingRecordID.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."ContractNumber" IS 'CTR-000001, minted by spAssignNextContractNumber from the seq_ContractNumber database SEQUENCE. Unique. NULLABLE at the schema level because MJ cannot express ''NOT NULL, assigned by the server on insert'' -- ContractEntityServer.Save() is what guarantees every contract has one. Gaps are normal and are not to be ''fixed'': a save that fails after taking a number leaves one behind, and UQ_Contract_ContractNumber is what guarantees no two contracts share a number.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."CompanyID" IS 'The SELLING company (__mj.Company) — which of OUR entities holds this agreement. Not the customer. Stored rather than derived because it is not reliably recoverable from the deal.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."CustomerOrganizationID" IS 'The customer. NOT NULL: contracts are B2B here by definition, and the individual case lives entirely in orders. v1 allowed an organization-or-person XOR; that is gone.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."PrimaryContactPersonID" IS 'Their named contact, optional.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."ContractTemplateID" IS 'The agreement version this contract incorporates. Nullable because a contract created automatically at Closed Won has none until finance reads the PDF.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."CreatingEntityID" IS 'Polymorphic reference part 1: the MJ Entity of the record that CREATED this contract, in practice Deals. A real foreign key to __mj.Entity — this is the half that is enforced, and the half that lets MJ resolve the pair generically. Same pattern accounting uses for JournalEntry provenance.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."CreatingRecordID" IS 'Polymorphic reference part 2: the creating records id. Soft by nature — it points at a record owned by an app this repo has no knowledge of. Set together with CreatingEntityID or not at all.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."ParentContractID" IS 'The contract this one amends. How a change order attaches: a change order is signed paper with its own PDF, dates and modifications, so it reuses this entity rather than getting one of its own. The original stays in force.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."SupersededByContractID" IS 'The contract that REPLACED this one, where an agreement was re-papered rather than amended. Also the sole source of the derived Superseded state, which is why the old CHECK tying it to a Status column disappeared with that column.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."SigningProviderURL" IS 'Direct link to the document in the signing provider (PandaDoc). The fallback that works before any integration exists, and when a storage sync has broken.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."EffectiveDate" IS 'When the agreement takes effect.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."ExecutedDate" IS 'When it was signed. May legitimately PRECEDE EffectiveDate — sign in December for a January start is the ordinary case. There is deliberately no constraint ordering the two; v1 had one and it rejected exactly the data a correct contract produces.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."EndDate" IS 'When the current term ends. This is what drives the renewal watchlist and every expiry projection.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."TerminatedDate" IS 'When the agreement ended early. Stored rather than derived: it is only recoverable from a successors effective date, and a contract can end with no successor at all when a customer simply leaves.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."AutoRenew" IS 'Whether the agreement auto-renews, AS THE PAPER STATES IT. True or false, no third state. Distinct from the subscriptions operational setting in orders, which someone can change later; when the two disagree that is a finding, not a bug.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."RenewalNoticeDays" IS 'Days of written notice we owe before a renewal price change, as stated in the agreement. NOT the same field as CancellationWindowDays even though many agreements set them equal — conflating them silently is how a notice obligation gets missed.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."CancellationWindowDays" IS 'Days of notice the customer owes to cancel without renewing.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."AnnualIncreasePercent" IS 'The negotiated year-over-year uplift. Exists here because it exists nowhere else: the orders schema has no escalation concept of any kind, which is why a two-year agreement stepping up 10% in year two is recorded in no other system.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."HasModifications" IS 'Whether the standard agreement was changed for this customer. ASSERTED by a person, not derived — its job is to say "go read the PDF" BEFORE anyone has recorded the modifications, and a derived flag would read false for every contract nobody has processed yet. One direction IS enforced server-side: if modification rows exist this must be true. It is never cleared automatically.';

COMMENT ON COLUMN __mj_BizAppsContracts."Contract"."Notes" IS 'Free-text working notes for whoever is processing the contract.';

COMMENT ON TABLE __mj_BizAppsContracts."ContractTemplateModification" IS 'What THIS contract changed about the standard agreement. Deliberately lean: it names a provision and carries what the contract says instead. Carries no ContractTemplateID — the provision belongs to exactly one template in every future, so the template derives through the provision, and a stored copy of a derivation can only agree or lie.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplateModification"."ContractTemplateProvisionID" IS 'The provision being modified — the structured identifier, and the only one. A server rule enforces what this replaces: the provision must belong to a template this contract incorporates.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplateModification"."ModificationText" IS 'What this contract says INSTEAD of the standard clause. Read as a pair with ContractTemplateProvision.ProvisionText.';

COMMENT ON COLUMN __mj_BizAppsContracts."ContractTemplateModification"."Notes" IS 'Optional working note, e.g. who negotiated it.';
...
CREATE OR ALTER FUNCTION "__mj_BizAppsContracts"."fnProvisionSortKey" (@ProvisionNumber VARCHAR(20))
RETURNS VARCHAR(200)
WITH SCHEMABINDING
AS
BEGIN
    ...
    DECLARE @out    VARCHAR(200) = N'';
    DECLARE @digits VARCHAR(20)  = N'';
    DECLARE @i      INTEGER = 1;
    DECLARE @len    INTEGER = LENGTH(@ProvisionNumber);
    DECLARE @c      NCHAR(1);
        ...
        BEGIN
            ...
            BEGIN
                ...
                SET @out = @out + RIGHT(REPLICATE(N'0', 6) + @digits,
                                        CASE WHEN LENGTH(@digits) > 6 THEN LENGTH(@digits) ELSE 6 END);
                SET @digits = N'';
            END
...
CREATE SEQUENCE __mj_BizAppsContracts.seq_ContractNumber
    AS INTEGER START WITH 1 INCREMENT BY 1 NO CACHE;
